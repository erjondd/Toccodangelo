...
class ShortcodeLoader
{
    ...
    private function addShortcodes() {
        $shortcodes_class_name = apply_filters('curly_twitter_filter_add_vc_shortcode', $shortcodes_class_name = array());
    ...
    public function load() {
        if (curly_twitter_theme_installed()) {
            $this->addShortcodes();
